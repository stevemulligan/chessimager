                         TrueType Font CHESS MOTIF
                          Update: August 12, 1998

  The figures of this font are quite simple and their outlines are bold. The
figurines was created in Corel Draw 3.0 and exported to TTF format in  Corel
Draw 7.0.  I made the font in  the  "Colegio La Salle de San Cristobal"  (La
...
Files in MOTIF_TT.ZIP:
         LEEME__F.TXT     This file in Spanish language.
         README_F.TXT     This file.
         MOTIFONT.TTF     CHESS MOTIF font - Ver. 1.1
         CHESMOTI.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESMOTI.DOC  which
...
not see these characters until the 'Chess Motif' font is installed  in  your
