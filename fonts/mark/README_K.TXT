                          TrueType Font CHESS MARK
                           Update: August 8, 1998

  The figures of this font are stylized and their silhouette turns out to be
quite simple.  Its design is based on some publications from  the 70s.  This
design is a option for  making  modern  chess  diagrams.  The  drawings  was
created in Corel Draw 3.0 and exported  to  TTF  format  in  Corel Draw 7.0.
I made the font in the "Colegio La Salle de San Cristobal"  (La Salle School
of San Cristobal), located in the mountains of the south of Mexico; in order
...
Files in MARK__TT.ZIP:
         LEEME__K.TXT     This file in English language.
         README_K.TXT     This file.
         MARKFONT.TTF     CHESS MARK font - Ver. 1.1
         CHESMARK.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESMARK.DOC  which
...
not see these characters until the  'Chess Mark'  font is installed in  your
