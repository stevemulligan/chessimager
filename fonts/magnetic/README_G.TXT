                        TrueType Font CHESS MAGNETIC
                           Update: August 8, 1998

I designed this font from the figures found in my  tavelling magnetic chess.
I have taken almost all the figures from there, and  I  made  some  changes.
The figurines was created in Corel Draw 3.0 and exported to  TTF  format  in
Corel Draw 7.0.  I did them in the  "Colegio La Salle de San Cristobal"  (La
Salle School of San Cristobal), located in the  pleasant  mountains  of  the
...
Files in MAGNE_TT.ZIP:
         LEEME__G.TXT     This file in English language.
         README_G.TXT     This file.
         MAGNFONT.TTF     CHESS MAGNETIC font - Ver. 1.1
         CHESMAGN.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESMAGN.DOC  which
...
not see these characters until the  'Chess Magnetic'  font is  installed  in
