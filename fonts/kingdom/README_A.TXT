                        TrueType Font CHESS KINGDOM
                          Update: August 8, 1998.

  The figurines of this font are very popular in many chess books  of  Latin
America.  I have taken the figures  from  a  some  Argentinean  chess  books
printed in Colombia (this is South America).  I made some little changes  to
...
Files in KINGD_TT.ZIP:
         LEEME__A.TXT     This file in English language.
         README_A.TXT     This file.
         KINGFONT.TTF     CHESS KINGDOM font - Ver. 1.1
         CHESKING.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESKING.DOC  which
...
not see these characters until the  'Chess Kingdom'  font  is  installed  in
