                       TrueType Font CHESS MEDIAEVAL
                          Update: August 12, 1998

I designed this font from the figures found in a Spanish dictionary of 1977,
where it explained something about the subject of chess. I have taken almost 
all the figures from there, and I only made slight  changes.  The  figurines
was created in Corel Draw 3.0 and exported to TTF format in  Corel Draw 7.0.
I did them in the  "Colegio La Salle de San Cristobal"  (La Salle School  of
San Cristobal), located in the mountains  of the south of Mexico;  in  order
to expand our collection of chess fonts.  The font is freeware, I hope it is
useful for the chess firends.  If you want to repay us, you can send us some
other fonts  for  creating  chess  diagrams  (we are collecting them).  Your
comments and suggestions would be welcome; please send  them  to  either  of
address that appear below.
                        
Files in MEVAL_TT.ZIP:
         LEEME__V.TXT     This file in Spanish language.
         README_V.TXT     This file.
         MVALFONT.TTF     CHESS MEDIAEVAL font - Ver. 1.1
         CHESMVAL.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESMVAL.DOC  which
...
not see these characters until the  'Chess Mediaeval'  font is installed  in
your computer.  The distribution of the figures on the keyboard is the  same
as in the CHESS MARROQUIN font, as follows:
