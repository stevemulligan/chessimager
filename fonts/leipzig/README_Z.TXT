                        TrueType Font CHESS LEIPZIG
                          Update: August 8, 1998.

  This font has been designed with figures found in  a  chess  book  of  the
beginning of this century.  The book was  printed  in  the  German  city  of
Leipzig, one of the major editorial centers of the world. The font was named
by Hans Bodlaender, webmaster of the page 'The Chess Variant Pages'  of  the
Universiteit Utrecht.  He sent me a copy of a chess diagram from the Leipzig
book.
...
south  of  Mexico; in order to expand our collection  of  chess  fonts.  The
font is freeware, I hope it is useful for the chess buddies.  If you want to
repay us, you can send us some other fonts for creating chess  diagrams  (we 
are collecting them). Your comments and suggestions would be welcome; please
send them to either of address that appear below.

Files in LEIPZ_TT.ZIP:
         LEEME__Z.TXT     This file in English language.
         README_Z.TXT     This file.
         LEIPFONT.TTF     CHESS LEIPZIG font - Ver. 1.1
         CHESLEIP.DOC     Sample and keymap.
...
processors  which  are  run  under  Windows.  The  file  CHESLEIP.DOC  which
...
not see these characters until the  'Chess Leipzig'  font  is  installed  in
